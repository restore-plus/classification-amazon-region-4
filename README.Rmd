...
Classification using HLS - Landsat/Sentinel-2 (2016 - 2021) for Region 4 defined in the scope of the Restore+ Project.
...
Next, open the `classification-amazon-region-4` directory in the RStudio and install the examples package:
...
The source code in this repository is licensed under GNU GENERAL PUBLIC LICENSE V3. Data and results are under the Creative Commons CC0 License.
